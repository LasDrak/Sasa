...
`,
  ...
  try {
  	const jam = moment.tz('Asia/Makassar').format('HH')
 var ucapanWaktu = 'Selamat Pagi 🌄'
				...
				ucapanWaktu = 'Good Afternoon2 🌅'

				} else if (jam >= '18' && jam <= '18') {
...
Note: If there is an error feature, please ask the owner!!..
`.trim(),
